"""
URL configuration for vizin project.
...
urlpatterns = [
    path('', TemplateView.as_view(template_name='inicial/apresentacao.html'), name='apresentacao'),
    ...
    path('encomendas/', include('apps.encomenda.urls')),
